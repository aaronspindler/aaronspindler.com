...
urlpatterns = [
    ...
    path(
        "album/<slug:slug>/download/<str:quality>/",
        views.download_album,
        name="download_album_quality",
    ),
    path(
        "album/<slug:slug>/download-status/",
        views.album_download_status,
        name="album_download_status",
    ),
    path(
