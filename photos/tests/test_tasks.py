...
class GenerateAlbumZipTaskTestCase(TestCase):
    ...
    def setUp(self):
        """Set up test data."""
        # Create test album
        self.album = PhotoAlbum.objects.create(title="Test Album", slug="test-album", allow_downloads=True)
    ...
    def test_generate_album_zip_success(self):
        ...
        with (
            patch.object(self.photo1.image, "open"),
...
class RegenerateAllAlbumZipsTaskTestCase(TestCase):
    ...
    def setUp(self):
        """Set up test data."""
        # Create test albums
        self.album1 = PhotoAlbum.objects.create(title="Album 1", slug="album-1", allow_downloads=True)
