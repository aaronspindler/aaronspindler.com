    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "moderation_note",
                    models.TextField(blank=True, help_text="Internal note about moderation decision"),
                ),
                (
                    "ip_address",
                ...
                (
                    "user_agent",
                    models.TextField(blank=True, help_text="Browser user agent for spam detection"),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["blog_template_name", "blog_category", "status"],
                        name="blog_blogco_blog_te_6d0ced_idx",
                    ),
                    models.Index(fields=["created_at"], name="blog_blogco_created_ebf67a_idx"),
                    models.Index(fields=["author"], name="blog_blogco_author__376d5d_idx"),
                    models.Index(fields=["status"], name="blog_blogco_status_cfc0e1_idx"),
                ],
            },
        ),
    ]
