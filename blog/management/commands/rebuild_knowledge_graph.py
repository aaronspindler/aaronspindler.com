...
from blog.knowledge_graph import GraphBuilder, build_knowledge_graph
...
class Command(BaseCommand):
    ...
    def _test_api_endpoint(self):
        ...
        try:
            ...
            message = (
                "API test passed" if response.status_code == 200 else f"API test failed (status {response.status_code})"
            )
