...
class Notification(models.Model):
    ...
    type = models.CharField(max_length=14, choices=TYPE_CHOICES, blank=True, null=True)
    
    action = models.ForeignKey("actions.Action", on_delete=models.CASCADE, null=True)
    action_status = models.ForeignKey("actions.ActionStatus", on_delete=models.CASCADE, null=True)
    
    endpoint = models.ForeignKey("web.Endpoint", on_delete=models.CASCADE, null=True)
    endpoint_status = models.ForeignKey("web.EndpointStatus", on_delete=models.CASCADE, null=True)
...
class LambdaRegion(models.Model):
    active = models.BooleanField(default=False)
    name = models.CharField(max_length=255)
    code = models.CharField(max_length=255, unique=True)
    code_prefix = models.CharField(max_length=2, blank=True, null=True)
    ...
    def get_flag(self):
        if self.flag_code:
            return mark_safe(f"<img src='{static('images/flags/' + self.flag_code + '.svg')}' width='20' />")
        return ''