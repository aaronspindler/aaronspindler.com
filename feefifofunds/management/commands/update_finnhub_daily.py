"""
Management command to fetch daily price updates from Finnhub.

This command should be run daily (via cron or Celery Beat) to keep fund data up-to-date.

Usage:
    python manage.py update_finnhub_daily
    python manage.py update_finnhub_daily SPY QQQ VOO
    python manage.py update_finnhub_daily --days 5  # Fetch last 5 days
"""
...
class Command(BaseCommand):
    help = "Fetch daily price updates from Finnhub for all active funds"
